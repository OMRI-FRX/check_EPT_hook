...
unsigned int __fastcall ALasmSizeOfAsm(void* code, ldasm_data* ld, UINT32 is64)
/*
 Description:
...
unsigned int get_inst_sz(PVOID add, UINT32 is64)
{
     return ALasmSizeOfAsm((PVOID)add, NULL, is64);
}
